            ...
            <section class="p-3">
                <div
                    ...
                    <div class="relative border-b dark:border-slate-600 px-7 flex items-center">
                        ...
                        <div class="ml-5">
                            <h3 class="pt-4 pb-1 uppercase text-sm font-bold">Tambah User</h3>
                            <p class="mb-6 text-sm">Tambah data user Mebelicious</p>
                        </div>
                    </div>

                    <form method="post" action="{{ route('user.add') }}" class="flex p-7" enctype="multipart/form-data">
                        @csrf
                        <div class="w-64">
                            <div class="flex justify-center items-center w-full">
                                <label for="foto"
                                    class="flex flex-col justify-center items-center w-64 h-64 bg-slate-50 rounded-full border-2 border-slate-300 border-dashed cursor-pointer dark:hover:bg-slate-500 dark:bg-slate-600 hover:bg-slate-100 dark:border-slate-500 dark:hover:border-slate-400 relative">
                        ...
                        <div class="pl-12 grow">
                            ...
                            <div class="flex">
                                <div class="pt-5 pr-5 basis-1/2">
                                    ...
                                    <input name="password" id="password" type="password"
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ketik password user..." required autocomplete="off"
                                        value="{{ old('password') }}">
                                ...
                                <div class="pt-5 pl-5 basis-1/2">
                                    ...
                                    <input name="password_confirmation" id="password_confirmation"
                                        ...
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ulangi password user..." required autocomplete="off"
                            ...
                            <div class="pt-5">
                                ...
                                <textarea name="address" id="address"
                                    class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                    placeholder="Ketik alamat user..." required autocomplete="off"
                            ...
                            <div class="flex">
                                <div class="pt-5 pr-5 basis-1/2">
                                    ...
                                    <input name="postcode" id="postcode" type="text"
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ketik kode pos user..." required autocomplete="off"
                                        value="{{ old('postcode') }}">
