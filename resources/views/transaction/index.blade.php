        ...
        <div class="block mb-5">
            <section class="p-3">
                <div class="bg-white dark:bg-slate-700 shadow-xl p-3 pb-7 rounded-xl relative overflow-hidden box-border">
                    <div class="relative">
                        <h3 class="p-4 pb-3 uppercase text-sm font-bold">Daftar Transaksi</h3>
                        <p class="mb-6 text-sm px-4">Daftar transaksi pada Mebelicious</p>
                        ...
                        <div class="flex items-center mb-5 px-4">
                            <div class="relative w-full">
                                ...
                                <input type="text" id="search" class="border bg-transparent text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 block w-full pl-10 p-2.5 dark:border-slate-500 border-slate-300" placeholder="Cari transaksi berdasarkan ID...">
                            </div>
                        </div>
                    </div>
...
<script type="module">
    $(document).ready(() => {
        ...
        function fetchData(page, search) {
            $.ajax({
                url: "/admin/transaction/data?page=" + page + "&search=" + search,
