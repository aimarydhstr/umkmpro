        ...
        <div class="block mb-5">
            <section class="p-3">
                <div
                    ...
                    <div class="relative">
                        <h3 class="p-4 pb-3 uppercase text-sm font-bold">Daftar Tag</h3>
                        <p class="mb-6 text-sm px-4">Daftar tag pada Mebelicious</p>
                ...
                <div class="p-6">
                    <div class="flex justify-center items-center w-full mb-3">
                        <label for="icons"
                            ...
                            <input id="icons" type="file" class="hidden" name="image">
                    ...
                    <div class="grow">
                        ...
                        <input name="name" id="name" type="text"
                            ...
                            placeholder="Nama Kategori..." required autofocus value="{{ old('name') }}">
                        @if($errors->has('name'))
...
$(document).ready(() => {
    ...
    function fetchData(page, search) {
        $.ajax({
            url: "/admin/tag/data?page=" + page + "&search=" + search,
