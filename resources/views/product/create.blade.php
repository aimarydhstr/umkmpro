        ...
        <div class="block mb-5">
            <section class="p-3">
                <div
                    ...
                    <form method="post" action="{{ route('product.add') }}" class="flex p-7"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="basis-1/3 pr-10">
                            <div class="flex justify-center items-center w-full">
                                <label for="foto"
                                    class="flex flex-col justify-center items-center w-full h-64 bg-slate-50 rounded-lg border-2 border-slate-300 border-dashed cursor-pointer dark:hover:bg-slate-500 dark:bg-slate-600 hover:bg-slate-100 dark:border-slate-500 dark:hover:border-slate-400 relative">
                                    <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                        ...
                                        <p class="text-xs text-slate-500 dark:text-slate-400">SVG, PNG, JPG, JPEG, WEBP
                                            atau GIF</p>
                                    </div>
                                    <input id="foto" type="file" class="hidden" name="image">
                                    <p class="hidden absolute text-sm text-slate-500 dark:text-slate-400 bottom-0 py-3 px-5 border-t left-0 right-0 text-center"
                                        id="namaFoto"></p>
                                </label>
                            </div>
                        </div>
                        <div class="basis-2/3">
                            <div>
                                ...
                                <input name="name" id="nama" type="text"
                                    ...
                                    placeholder="Ketik nama produk..." required autocomplete="off" autofocus
                                    value="{{ old('name') }}">
                                @if($errors->has('name'))
                            ...
                            <div class="pt-3">
                                ...
                                <textarea name="description" id="description"
                                    class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                    placeholder="Ketik deskripsi produk..." required autocomplete="off"
                            ...
                            <div class="flex">
                                ...
                                <div class="pt-5 pl-5 basis-1/2">
                                    ...
                                    <input name="qty" id="stok" type="number"
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ketik stok produk..." required autocomplete="off"
                                        value="{{ old('qty') }}">
                                    @if($errors->has('qty'))
                            ...
                            <div class="flex">
                                <div class="pt-5 pr-5 basis-1/2">
                                    ...
                                    <input name="price" id="price" type="number"
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ketik harga..." required autocomplete="off"
                                        value="{{ old('price') }}">
                                    @if($errors->has('price'))
                                ...
                                <div class="pt-5 pl-5 basis-1/2">
                                    ...
                                    <input name="discount" id="discount" type="number"
                                        class="p-3 focus:outline-none focus:ring focus:ring-violet-500 rounded-lg w-full border my-3 dark:bg-slate-700 dark:border-slate-600 border-slate-300"
                                        placeholder="Ketik diskon (%)..." autocomplete="off"
                                        value="{{ old('discount') }}">
