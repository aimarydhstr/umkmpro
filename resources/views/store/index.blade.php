    ...
    <div class="w-full border rounded-lg p-2.5">
        <div class="flex justify-between pl-0 sm:pl-5">
            <div class="flex space-x-2 items-center">
                <div style="background-image: url({{asset('./img/store/'. $store->photo)}})" class="w-20 h-20 border-4 border-blue-400 rounded-full bg-cover bg-center"></div>
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <div class="flex flex-col sm:flex-row space-y-1 sm:space-y-0 space-x-0 sm:space-x-2">
                            ...
                            <a href="{{url('https://wa.me/'.$store->phone)}}" class="whitespace-nowrap flex items-center bg-blue-500 text-white font-medium pr-3 pl-2.5 py-1.5 rounded-md hover:bg-blue-600 focus:ring">
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <svg class="w-4 mr-1" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-6h.008v.008H12v-.008zM12 15h.008v.008H12V15zm0 2.25h.008v.008H12v-.008zM9.75 15h.008v.008H9.75V15zm0 2.25h.008v.008H9.75v-.008zM7.5 15h.008v.008H7.5V15zm0 2.25h.008v.008H7.5v-.008zm6.75-4.5h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V15zm0 2.25h.008v.008h-.008v-.008zm2.25-4.5h.008v.008H16.5v-.008zm0 2.25h.008v.008H16.5V15z"></path>
                        ...
                        Buka Sejak : {{$store->created_at->diffforhumans()}}
                    </div>
                </h3>
...
<div class="mt-5 px-8 sm:px-20">
    <h1 class="text-xl">Produk Terbaru</h1>
    <div class="w-full grid place-items-center grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
    @foreach($products as $product)
        <div class="shadow-md w-full rounded-md space-y-2 px-2">
            <div style="background-image: url({{asset('/img/product/'.$product->image)}});" class="border bg-cover bg-center h-48 rounded"></div>
            <div class="font-semibold text-gray-700">
            <a href="{{route('shop.getproduct', $product->slug)}}" title="{{$product->name}}">{{$product->name}}</a>
            </div>
                    <div class="text-xl font-bold mb-1">
                        Rp. {{str_replace(',', '.', number_format($product->price - $product->price * ($product->discount / 100)))}}
                    </div>
